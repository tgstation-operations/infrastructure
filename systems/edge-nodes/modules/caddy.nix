    ...
    virtualHosts = {
      ...
      "tgstation13.org" = {
        ...
        extraConfig = ''
          ...
          redir /wiki/ https://wiki.tgstation13.org/
          redir /wiki/*.php* https://wiki.tgstation13.org/{http.request.orig_uri.path.file}?{http.request.orig_uri.query}{http.request.orig_uri.path.*/}
        '';
      };
      "forums.tgstation13.org" = {
      ...
      "wiki.tgstation13.org" = {
        ...
        extraConfig = ''
          ...
          @static_files path_regexp ^/(resources/(assets|lib|src)|(skins|extensions)/.+\.(css|js|gif|jpg|jpeg|png|svg|wasm|ttf|woff|woff2)^)
          @not_a_file {
            ...
            not path_regexp ^/(resources/(assets|lib|src)|(skins|extensions)/.+\.(css|js|gif|jpg|jpeg|png|svg|wasm|ttf|woff|woff2)^)
          }
