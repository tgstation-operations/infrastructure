{
  ...
  security.acme = {
    ...
    certs = {
      "tgs.tgsatan.us.tgstation13.org" = {
        dnsProvider = "route53";
        credentialFiles = {
      ...
      "s3-web.tgsatan.us.tgstation13.org" = {
        dnsProvider = "route53";
        credentialFiles = {
          "AWS_SHARED_CREDENTIALS_FILE" = config.age.secrets.aws_credentials.path;
        };
  ...
  services.caddy = {
    ...
    virtualHosts = {
      ...
      "s3.tgsatan.us.tgstation13.org" = {
        useACMEHost = "s3.tgsatan.us.tgstation13.org";
        extraConfig = ''
          encode gzip zstd
          reverse_proxy localhost:3900 {
            health_uri /health
      ...
      "s3-web.tgsatan.us.tgstation13.org" = {
        useACMEHost = "s3-web.tgsatan.us.tgstation13.org";
        extraConfig = ''
          encode gzip zstd
          reverse_proxy localhost:3902 {
            health_uri /health
      ...
      "admin.s3.tgsatan.us.tgstation13.org" = {
        useACMEHost = "admin.s3.tgsatan.us.tgstation13.org";
        extraConfig = ''
          encode gzip zstd
      ...
      "attic.tgstation13.org" = {
        useACMEHost = "attic.tgstation13.org";
        extraConfig = ''
          encode gzip zstd
          reverse_proxy localhost:9228
        '';
      };
    };
  };
